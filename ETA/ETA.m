...
- (NSArray *)buildRequestArrayWithOptions:(NSDictionary *)options
{
    ...
    if (self.apiKey) [requestArray addObject:[NSDictionary dictionaryWithObject:self.apiKey forKey:@"api_key"]];
    if (self.UUID) [requestArray addObject:[NSDictionary dictionaryWithObject:self.UUID forKey:@"api_uuid"]];
    ...
    if (self.latitude) [requestArray addObject:[NSDictionary dictionaryWithObject:[NSString stringWithFormat:@"%f", self.latitude] forKey:@"api_latitude"]];
    if (self.longitude) [requestArray addObject:[NSDictionary dictionaryWithObject:[NSString stringWithFormat:@"%f", self.longitude] forKey:@"api_longitude"]];
    if (self.distance > 0) [requestArray addObject:[NSDictionary dictionaryWithObject:[NSString stringWithFormat:@"%d", self.distance] forKey:@"api_distance"]];
    if (self.locationDetermined > 0) [requestArray addObject:[NSDictionary dictionaryWithObject:[NSString stringWithFormat:@"%d", self.locationDetermined] forKey:@"api_locationDetermined"]];
    if (self.geocoded) [requestArray addObject:[NSDictionary dictionaryWithObject:@"1" forKey:@"api_geocoded"]];
    else [requestArray addObject:[NSDictionary dictionaryWithObject:@"0" forKey:@"api_geocoded"]];
    if (self.accuracy > 0 && !self.geocoded) [requestArray addObject:[NSDictionary dictionaryWithObject:[NSString stringWithFormat:@"%d", self.accuracy] forKey:@"api_accuracy"]];
    ...
    for (NSDictionary *keyValuePair in requestArray) {
        [concatenatedValues appendString:[keyValuePair objectForKey:[[keyValuePair allKeys] objectAtIndex:0]]];
    }
