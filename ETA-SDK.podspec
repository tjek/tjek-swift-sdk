Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                     An SDK that makes it easy to talk to eTilbudsavis' API.
  ...
  s.source       = { :git => "https://github.com/eTilbudsavis/native-ios-eta-sdk.git", 
                     :tag => "v2.0.0-beta1" }
  ...
  s.frameworks   = 'CoreLocation', 'CoreGraphics', 'UIKit'

  s.dependency 'AFNetworking', '~> 1.3.1'
  s.dependency 'Mantle', '~> 1.1'
