...
class TjekEventsTrackerConfigTests: XCTestCase {
    ...
    func testLoadingPlist() throws {
        ...
        let expectedLegacyConfig = try TjekEventsTracker.Config(trackId: "<legacy trackId>", baseURL: URL(string: "https://wolf-api.tjek.com")!, dispatchInterval: 120.0, dispatchLimit: 100, enabled: true)
