...
extension APIv2Request {
    ...
    static func getPublicationPages(withId pubId: PublicationId, aspectRatio: Double? = nil) -> APIv2Request<[PublicationPage_v2]> {
        .init(APIRequest<[v2ImageURLs]>(
    ...
    static func getPublicationHotspots(withId pubId: PublicationId, aspectRatio: Double) -> APIv2Request<[PublicationHotspot_v2]> {
        .init(APIRequest<[PublicationHotspot_v2]>(
