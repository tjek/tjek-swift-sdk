...
public final class ShopGun {
    public static var logHandler: LogHandler?
...
extension ShopGun {
    ...
    /**
     Forwards a message to the static ShopGun.logHandler callback. Prefixes the message with a 'source name' (eg. "[ShopGunSDK.CoreAPI]", based on the provided `LogSource`.
