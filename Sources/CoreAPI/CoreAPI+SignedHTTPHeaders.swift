...
extension CoreAPI {
    // Takes an auth token/secret pair and returns a dictionary containing the token & signed signature
    internal static func signedHTTPHeaders(for auth:(token: String, secret: String)) -> [String: String] {
