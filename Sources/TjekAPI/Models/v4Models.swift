...
extension Business_v4: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.logotypesForWhite = Set((try c.decode([FailableDecodable<ImageURL>].self, forKey: .logotypesForWhite)).compactMap(\.value))
        self.logotypesForPrimary = Set((try c.decode([FailableDecodable<ImageURL>].self, forKey: .logotypesForPrimary)).compactMap(\.value))
...
extension Offer_v4: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.images = Set((try c.decode([FailableDecodable<ImageURL>].self, forKey: .images)).compactMap(\.value))
