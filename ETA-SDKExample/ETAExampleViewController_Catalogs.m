//
//  ETAExampleViewController_Catalogs.m
//  ETA-SDKExample
//
...
#import "ETAExampleViewController_Catalogs.h"
...
@interface ETAExampleViewController_Catalogs () <UITableViewDataSource, UITableViewDelegate>

@property (nonatomic, readwrite, strong) NSMutableArray* catalogs;

@end

@implementation ETAExampleViewController_Catalogs
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    {
        ETAExampleViewController_PageFlip* pageFlip = (ETAExampleViewController_PageFlip*)segue.destinationViewController;
